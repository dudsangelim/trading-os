"""btc_lead paper engine — live execution state machine.
...
100% side-match, corr 1.0000). btc_lead is a pure signal-exit strategy, so the
stop/target/trail branches below are inert (kept for fidelity of the port).
